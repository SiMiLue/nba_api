...
from .functions import get_player_image
...
def nba_results(request):
    ...
    return render(request, 'game_result.html', context=context)
...
def game_leaders(request, num):
    ...
    home_player_image = get_player_image(home_player_id)
    away_player_image = get_player_image(away_player_id)
    ...
    return render(request, 'game_leaders.html', context=context)